    ...
    <body style="background-image:url('img/background.jpg');">
        ...
        <section>
            <div class="container">
                ...
                echo "<div>";
                    echo "<div class='p-2 mb-0 bg-dark text-light' style='opacity:90%;'>";
                        echo "<h4 style='text-align:center;'>Detalhes da Compra</h4>";
                    echo "</div>";
                    echo "<table class='table table-bordered table-light' style='opacity:90%; text-align:center;'>";
                        echo "<tr>";
                        ...
                        while($pedidos_produtos=mysqli_fetch_array($sql)){
                            ...
                            echo "<tr>";
                                ...
                                if($_SESSION['tipo']!="cliente"){
                                    ...
                                    echo "<button type='submit' name=idproduto value='$idproduto' class='btn btn-dark btn-sm'>Dar Desconto</button></form>";
                                    ...
                                    echo "<button type='submit' name=idproduto value='$idproduto' class='btn btn-dark btn-sm'>Dar Desconto</button></form></td>";
                                }
                            echo "</tr>";
                        }
                    echo "</table>";
